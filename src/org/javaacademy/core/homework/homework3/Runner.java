...
public class Runner {
    ...
    public static void ex4() {
        ...
        House house2 = new House("Кирова", "2");

        City city = new City("Мурманск", new House[]{house1, house2});
        House house = city.getHouses()[0];
        house.setStreet("Солнечная");
        System.out.println(city);
    }
    ...
    public static void ex2() {
        ...
        //Умеет создавать iphone и заполняет его двумя процессорами (1000 Mhz), 8 мегапиксельной камерой,
        // и корпусом 60х200х10
        //
        //Создать фабрику Samsung, которая:
        //Умеет создавать и заполняет его процессором (1500 Mhz), 16 мегапиксельной камерой,
